...
#   c) node1 mines 32 blocks, so now node 0 has 60001c2c, node 1 has 4250c2c, node2 has none.
#   d) node0 sends 601 c2c to node2, in two transactions (301 c2c, then 300 c2c).
