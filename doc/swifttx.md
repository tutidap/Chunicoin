...
This mechanism has been integrated into Bitcore-Node-CHUNICOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CHUNICOIN-Project/insight-api-chunicoin#web-socket-api](https://github.com/CHUNICOIN-Project/insight-api-chunicoin#web-socket-api) 
* API: [https://github.com/CHUNICOIN-Project/insight-api-chunicoin#swifttx-transactions](https://github.com/CHUNICOIN-Project/insight-api-chunicoin#swifttx-transactions) 
...
By default, the CHUNICOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CHUNICOIN Core daemon:
