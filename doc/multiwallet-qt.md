...
In order to support loading of multiple wallets in chunicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is chunicoin.cpp.
...
Changes to chunicoin.cpp
----------------------
chunicoin.cpp is the entry point into chunicoin-qt, and as such, will require some minor modifications to provide hooks for
