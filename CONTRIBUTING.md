Contributing to CHUNICOIN Core
============================

The CHUNICOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CHUNICOIN Core project, and is not to be
confused with overall CHUNICOIN Network Protocol consensus changes.

Whether a pull request is merged into CHUNICOIN Core rests with the project merge
...
Patches that change CHUNICOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the CHUNICOIN consensus, it must have been
...
The project leader is the release manager for each CHUNICOIN Core release.
