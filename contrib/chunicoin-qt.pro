...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/chunicoin-cli.cpp \
           src/chunicoin-tx.cpp \
           src/chunicoin.cpp \
           src/db.cpp \
           ...
           src/qt/chunicoin.cpp \
           src/qt/chunicoinstrings.cpp \
...
RESOURCES += src/qt/chunicoin.qrc src/qt/chunicoin_locale.qrc

TRANSLATIONS += src/qt/locale/chunicoin_bg.ts \
                src/qt/locale/chunicoin_de.ts \
                src/qt/locale/chunicoin_en.ts \
                src/qt/locale/chunicoin_es.ts \
                src/qt/locale/chunicoin_fi.ts \
                src/qt/locale/chunicoin_fr.ts \
                src/qt/locale/chunicoin_it.ts \
                src/qt/locale/chunicoin_ja.ts \
                src/qt/locale/chunicoin_pl.ts \
                src/qt/locale/chunicoin_pt.ts \
                src/qt/locale/chunicoin_ru.ts \
                src/qt/locale/chunicoin_sk.ts \
                src/qt/locale/chunicoin_sv.ts \
                src/qt/locale/chunicoin_vi.ts \
                src/qt/locale/chunicoin_zh_CN.ts \
                src/qt/locale/chunicoin_zh_TW.ts
