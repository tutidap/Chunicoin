...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Chunicoin Core chunicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  chunicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chunicoin transaction") + "\n" +
                               "  chunicoin-tx [options] -create [commands]   " + _("Create hex-encoded chunicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chunicoin transaction
