...
// Copyright (c) 2016-2017 A1B2C3D4
...
// CHUNICOIN: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // CHUNICOIN: add to spork database.
