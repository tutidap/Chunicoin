 ...
 */
    ...
    typeWidget->addItem(tr("Received C2C from zC2C"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zC2C"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zC2C));
