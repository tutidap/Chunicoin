...
/** Utility functions used by the CHUNICOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render CHUNICOIN addresses in monospace font
...
// Parse "chunicoin:" URI into recipient object, return true on successful parsing
