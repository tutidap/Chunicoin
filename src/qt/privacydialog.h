...
public:
    ...
    void setZC2CControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzC2C_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzC2C_clicked();
    void on_pushButtonZC2CControl_clicked();
