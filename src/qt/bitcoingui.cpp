                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CHUNICOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CHUNICOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chunicoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zC2C"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CHUNICOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about CHUNICOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CHUNICOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CHUNICOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CHUNICOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a CHUNICOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CHUNICOIN Core help message to get a list with possible CHUNICOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CHUNICOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CHUNICOIN network", "", count));
}
...
{
    QString strTitle = tr("CHUNICOIN Core"); // default title
