...
/* Chunicoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CHUNICOIN"
#define QAPP_ORG_DOMAIN "chunicoin.org"
#define QAPP_APP_NAME_DEFAULT "CHUNICOIN-Qt"
#define QAPP_APP_NAME_TESTNET "CHUNICOIN-Qt-testnet"
